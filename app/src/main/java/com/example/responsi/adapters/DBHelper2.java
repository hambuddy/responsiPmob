...
public class DBHelper2 extends SQLiteOpenHelper {
    ...
    public static final String database_name = "db_uadmart";
    public static final String tabel_name = "table_barang";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query = "CREATE TABLE "+ tabel_name + "(" + row_id + " INTEGER PRIMARY KEY AUTOINCREMENT,"
                + row_nama + " TEXT, " + row_harga + " TEXT, " + row_deskripsi + " TEXT, " + row_status + " TEXT) ";
        db.execSQL(query);
    }
